...
static void stack_init(void *arg)
{
   ...
   // (void)SILICONID_ConvertToMacAddr(&enet_config.macAddress);
    ...
    enet_config.macAddress[0]= 0x54;
    enet_config.macAddress[1]= 0x27;
    enet_config.macAddress[2]= 0x8d;
    enet_config.macAddress[3]= 0x5c;
    enet_config.macAddress[4]= 0x55;
    enet_config.macAddress[5]= 0xe2;
